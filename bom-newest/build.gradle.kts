...
bomGenerator {
    ...
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-core", "7.3.4")
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-bukkit", "7.3.4")
