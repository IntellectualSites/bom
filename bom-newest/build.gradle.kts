...
bomGenerator {
    ...
    includeDependency("net.kyori", "adventure-api", "4.15.0")
    ...
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-core", "7.3.2")
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-bukkit", "7.3.2")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Core", "2.8.4")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Bukkit", "2.8.4")
