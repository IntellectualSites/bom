...
bomGenerator {
    ...
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-core", "7.5.7")
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-bukkit", "7.5.7")
