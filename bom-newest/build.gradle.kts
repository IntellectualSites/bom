...
bomGenerator {
    ...
    // Paper
    includeDependency("io.papermc.paper", "paper-api", "1.19.1-R0.1-SNAPSHOT")

    // Third party dependencies
    includeDependency("org.checkerframework", "checker-qual", "3.23.0")
    ...
    includeDependency("com.plotsquared", "PlotSquared-Core", "6.9.3")
    includeDependency("com.plotsquared", "PlotSquared-Bukkit", "6.9.3")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Core", "2.4.2")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Bukkit", "2.4.2")
