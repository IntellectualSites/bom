...
bomGenerator {
    ...
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-core", "7.3.6")
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-bukkit", "7.3.6")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Core", "2.9.1")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Bukkit", "2.9.1")
