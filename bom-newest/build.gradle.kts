...
bomGenerator {
    ...
    // Paper
    includeDependency("io.papermc.paper", "paper-api", "1.21.8-R0.1-20250906.215025-55")

    // Third party dependencies
    includeDependency("org.checkerframework", "checker-qual", "3.54.0")
    ...
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-core", "7.5.12")
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-bukkit", "7.5.12")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Core", "2.15.0")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Bukkit", "2.15.0")
    ...
    includeDependency("org.bstats", "bstats-bukkit", "3.2.1")
    includeDependency("org.bstats", "bstats-base", "3.2.1")
