...
bomGenerator {
    ...
    includeDependency("org.checkerframework", "checker-qual", "3.34.0")
    ...
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Core", "2.6.1")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Bukkit", "2.6.1")
