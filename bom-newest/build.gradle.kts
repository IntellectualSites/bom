...
bomGenerator {
    ...
    includeDependency("net.kyori", "adventure-api", "4.23.0")
    includeDependency("net.kyori", "adventure-text-minimessage", "4.23.0")
    includeDependency("net.kyori", "adventure-platform-bukkit", "4.4.0")

    // IntellectualSites plugins
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-core", "7.5.4")
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-bukkit", "7.5.6")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Core", "2.13.1")
