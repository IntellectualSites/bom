...
bomGenerator {
    ...
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-core", "7.4.2")
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-bukkit", "7.4.2")
