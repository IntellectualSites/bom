...
bomGenerator {
    ...
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-core", "7.0.0-rc.4")
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-bukkit", "7.0.0-rc.4")
