...
bomGenerator {
    ...
    includeDependency("org.checkerframework", "checker-qual", "3.33.0")
    // Adventure & Minimessage
    includeDependency("net.kyori", "adventure-api", "4.13.0")
    includeDependency("net.kyori", "adventure-text-minimessage", "4.13.1")
    ...
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Core", "2.6.0")
    includeDependency("com.fastasyncworldedit", "FastAsyncWorldEdit-Bukkit", "2.6.0")
