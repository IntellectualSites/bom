...
bomGenerator {
    ...
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-core", "7.3.3")
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-bukkit", "7.3.3")
