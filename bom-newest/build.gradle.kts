...
bomGenerator {
    ...
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-core", "7.3.1")
    includeDependency("com.intellectualsites.plotsquared", "plotsquared-bukkit", "7.3.1")
